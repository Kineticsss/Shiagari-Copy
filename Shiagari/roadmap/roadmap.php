...
<body>
  ...
  <main class="main">
    ...
    <div class="action-buttons">
      <button class="btn btn-primary" id="addEpicBtn"><i class="fas fa-plus"></i> Add Epic</button>
      <button class="btn btn-secondary" id="viewTasksBtn"><i class="fas fa-tasks"></i> View All</button>
    </div>
  </main>
